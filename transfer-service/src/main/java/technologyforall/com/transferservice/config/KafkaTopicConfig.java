...
public class KafkaTopicConfig {
    ...
    public NewTopic transferInitiatedDlt() {
        return TopicBuilder.name("transfer.initiated.DLT")
                .partitions(3)
                .replicas(3)
                .build();
    }
    ...
    public NewTopic chargeCalculatedDlt() {
        return TopicBuilder.name("charge.calculated.DLT")
                .partitions(3)
                .replicas(3)
                .build();
    }
    ...
    public NewTopic ledgerRecordedDlt() {
        return TopicBuilder.name("ledger.recorded.DLT")
                .partitions(3)
                .replicas(3)
                .build();
    }
    ...
    public NewTopic transferCompletedDlt() {
        return TopicBuilder.name("transfer.completed.DLT")
                .partitions(3)
                .replicas(3)
                .build();
    }
